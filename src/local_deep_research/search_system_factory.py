    ...
    **kwargs,
    ...
    if strategy_name_lower in [
        ...
        return LangGraphAgentStrategy(
            ...
            if kwargs.get("include_sub_research") is not None
            else _get_setting(
                settings_snapshot,
                "langgraph_agent.include_sub_research",
                True,
            ...
            trace_output_dir=kwargs.get("trace_output_dir"),
            primary_only_tools=kwargs.get("primary_only_tools", False),
            search_engine_allowlist=kwargs.get("search_engine_allowlist"),
            research_profile=kwargs.get("research_profile", "default"),
            query_rewrite_enabled=kwargs.get("query_rewrite_enabled", True),
            routing_mode=kwargs.get("routing_mode", "auto"),
            static_official_domain=kwargs.get("static_official_domain"),
            task_contract=kwargs.get("task_contract"),
            all_links_of_system=all_links_of_system,
            settings_snapshot=settings_snapshot,
        )
