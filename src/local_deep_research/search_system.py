...
class AdvancedSearchSystem:
    ...
    def __init__(
        ...
        agent_synthesis_model: BaseChatModel | None = None,
    ):
        ...
        if strategy_name.lower() in [
            ...
            self.strategy = create_strategy(
                ...
                primary_only_tools=agent_primary_only_tools,
                search_engine_allowlist=agent_search_engine_allowlist,
                research_profile=agent_research_profile,
                routing_mode=agent_routing_mode,
                static_official_domain=agent_static_official_domain,
                task_contract=agent_task_contract,
                include_sub_research=agent_include_sub_research,
                query_rewrite_enabled=agent_query_rewrite_enabled,
                synthesis_model=agent_synthesis_model,
            )
