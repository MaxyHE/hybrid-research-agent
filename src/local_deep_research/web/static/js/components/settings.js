...
(function() {
    ...
    function organizeSettings(settings, tab) {
        ...
        const filteredSettings = settings.filter(setting => {
            // Retained in storage for historical runs, not controls for Hybrid ODR.
            if (['search.search_strategy', 'search.iterations', 'search.questions_per_iteration'].includes(setting.key)) {
                return false;
            }
