...
def _init_search_system(
    ...
    agent_primary_only_tools: bool = False,
    agent_search_engine_allowlist: list[str] | None = None,
    agent_research_profile: str = "default",
    agent_routing_mode: str = "auto",
    agent_static_official_domain: str | None = None,
    agent_task_contract: dict[str, Any] | None = None,
    agent_include_sub_research: bool | None = None,
    agent_query_rewrite_enabled: bool = True,
    agent_synthesis_model: Any | None = None,
    ...
    **kwargs: Any,
    ...
    try:
        ...
        system = AdvancedSearchSystem(
            ...
            agent_primary_only_tools=agent_primary_only_tools,
            agent_search_engine_allowlist=agent_search_engine_allowlist,
            agent_research_profile=agent_research_profile,
            agent_routing_mode=agent_routing_mode,
            agent_static_official_domain=agent_static_official_domain,
            ...
            agent_synthesis_model=agent_synthesis_model,
        )
    except Exception:
        from ..utilities.resource_utils import safe_close
    ...
    **kwargs: Any,
    ...
    try:
        ...
        return {
            ...
            "tool_names": results.get("tool_names", []),
            "research_profile": results.get("research_profile", "default"),
            "routing_mode": results.get("routing_mode", "adaptive_hybrid"),
        }
    finally:
